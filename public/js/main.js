...
var _user$project$Cart_State$availableProducts = _elm_lang$core$Native_List.fromArray(
	[
		A6(_user$project$Cart_Types$Product, '1', 'Best product ever. Delivers instantly via email.', _elm_lang$core$Maybe$Nothing, 'Product 1', 1, true),
		A6(_user$project$Cart_Types$Product, '2', 'Delivers immediately via email.', _elm_lang$core$Maybe$Nothing, 'Product 2', 0.1, true)
	]);
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-header-checkout'),
...
var _user$project$Cart_View$formatCurrency = function (amount) {
	return A2(_ggb$numeral_elm$Numeral$format, '$0,00.00', amount);
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-logo row')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
